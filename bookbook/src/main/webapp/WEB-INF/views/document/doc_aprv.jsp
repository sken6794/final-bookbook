					...
					<div class="panel panel-inverse" data-sortable-id="form-stuff-1"
						...
						<div class="panel-body">
							<form id="docForm" name="docForm" action="document"
								...
								<!-- ${member.mname} -->
								<p style="line-height: 160%;">결재 &nbsp;&nbsp;  ${document.docaprv }</p>
								<!-- 
								if($(document.midaprv) == 휴가 중
								휴가
								 -->
								
								<p style="line-height: 160%;">기안일 &nbsp;&nbsp;  ${document.docdate }</p>
								<p style="line-height: 160%;">결제일 &nbsp;&nbsp;  ${document.doccomp }</p>
								<p style="line-height: 160%;">
									<span style="font-size: 10pt;">문서번호 &nbsp;&nbsp; ${document.docno }</span>
								</p>
								<div class="form-group">
									<div class="col-md-9" align="right">
										<button type="submit" id="aprv"
											class="btn btn-sm btn-success" style="margin: 1px;">결재</button>
										<a href="#modal-dialog" class="btn btn-sm btn-danger" data-toggle="modal"
											style="margin: 1px;">반려</a>
									</div>
									<!-- 주문내역 수정 팝업 -->
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" style="text-align: center; font-weight: bold;">반려사유</h4>
									</div>
									<!-- 주문 수정 form -->
									...
									<div class="modal-body">
										...
										<div class="modal-footer">
											...
											<a href="javascript:;" class="btn btn-sm btn-primary">확인</a>
										</div>
		                            	</form>
									</div>
								</div>
