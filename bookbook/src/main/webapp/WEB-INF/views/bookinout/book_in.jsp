...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<!-- ================== END PAGE LEVEL STYLE ================== -->
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">입고 조회<small></small></h1>
			<!-- end page-header -->
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                   	...
                                   	<c:forEach var="bookin" items="${bookInList }">
	                                    <tr class="odd gradeX">
	                                        <td>${bookin.bookIn.binno }</td>
	                                        <td>${bookin.bookIn.bcode}</td>
	                                        <td>${bookin.book.bname}</td>
